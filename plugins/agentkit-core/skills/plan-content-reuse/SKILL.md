---
name: plan-content-reuse
description: >
  Use when a source artifact such as training, research, code, notes or a client solution should be repurposed into multiple useful outputs.
---
# Plan Content Reuse
Compose:
